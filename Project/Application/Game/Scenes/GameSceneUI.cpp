...
#include "GameSceneUI.h"
 ...
 //スプライトの遷移用のベクター
const std::vector<CommandSpriteType> GameSceneUI::sSpriteOrder_ = {
...
void GameSceneUI::UpdateCommandSprite()
{
	//操作説明の開閉
...
void GameSceneUI::ChangeCommandSprite()
{
	//スプライトの移動に必用な定数
...
void GameSceneUI::ApplyCommandSprite(int changeAmount)
{
	//現在のスプライトインデックスを取得
...
void GameSceneUI::AnimationTitle()
{
	//タイトルの文字を動かす
